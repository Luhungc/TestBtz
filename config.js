...
global.stik = global.swb + "tik";
global.sdc = global.swb + "dc";
global.sgc = global.swb + "gc";
...
global.wait = "_𝚃𝚞𝚗𝚐𝚐𝚞 𝚂𝚎𝚋𝚎𝚗𝚝𝚊𝚛⏲️_";
...
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ WEBSITE APIKEY ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.openai =
  process.env.openai || "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";
...
global.NumberF = customFormat;
global.NumberF2 = abbreviateNumber;
...
function customFormat(
  ...
  const addSuffix = (num) => {
    const pad3 = (str = "") => str.padEnd(suffixPadLength, " "); //pad 0 spaces if necessary
...
//Function By FongsiDev
global.getAge = (birthDate) =>
